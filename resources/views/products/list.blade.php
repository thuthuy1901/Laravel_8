<div class="row isotope-grid">
    @foreach ($products as $key => $product)
        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
            <!-- Block2 -->
            <div class="block2 d-flex flex-column justify-content-center" style="height: 385px;">
                <div class="block2-pic hov-img0 h-100">
                    <img src="{{ $product->thumb }}" alt="IMG-PRODUCT" class="img-fluid h-100">
