...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <p>Giá gốc: {!! number_format($product->price) !!}</p>
                        <span class="mtext-106 cl2">
                            Giá sale: {!! number_format($product->price_sale) !!}
                        </span>
                ...
                <div class="tab01">
                    ...
                    <div class="tab-content p-t-43">
                        ...
                        <div class="tab-pane fade show active" id="description" role="tabpanel">
                            <div class="how-pos2 p-lr-15-md d-flex" style="gap:100px;">
                                    ...
                                    <div class="p-b-30 m-lr-15-sm">
                                        ...
                                        <div class="flex-w flex-t p-b-68">
                                            <div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
                                                <img src="{{ $product->thumb }}" alt="AVATAR">
                                            </div>
    ...
    <div class="sec-relate-product bg0 p-t-45 p-b-105">
        <div class="container">
            <div class="p-b-45">
                <h3 class="ltext-106 cl-5 txt-center">
                    Sản phẩm khác
                </h3>
            </div>
