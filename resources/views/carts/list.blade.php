...
@section('content')
    ...
    @if (count($products) != 0)
        <form class="bg0 p-t-150 p-b-85" method="post">
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                        <div class="m-l-25 m-r--38 m-lr-0-xl">
                                ...
                                <table class="table-shopping-cart">
                                    <tbody>
                                        ...
                                        @foreach ($products as $key => $product)
                                            @php
                                                $priceEnd = $product->price_sale * $carts[$product->id];
                                                $total += $priceEnd;
                                            @endphp
                                            <tr class="table_row">
                                                <td class="column-1">
                                                ...
                                                <td class="column-3">{{ number_format($product->price_sale) }}</td>
                                                <td class="column-4">
                            ...
                            <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                                ...
                                <input value="Cập nhập" type="submit" formaction="/update-cart"
                    ...
                    <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                        <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                            ...
                            <div class="flex-w flex-t bor12 p-t-15 p-b-30 w-full">
